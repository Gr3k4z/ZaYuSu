#pragma checksum "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\Contact.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6d712e9b5a2465bc0ea715ed262f60e6260cb537"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6d712e9b5a2465bc0ea715ed262f60e6260cb537", @"/Views/Home/Contact.cshtml")]
    ...
    public class Views_Home_Contact : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\Contact.cshtml"
...
#line 4 "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\Contact.cshtml"
...
#line 5 "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\Contact.cshtml"
...
");
            EndContext();
            BeginContext(471, 2050, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dab6723a36b64964a84a8bebcc5b1479", async() => {
                BeginContext(477, 2037, true);
                WriteLiteral(@"
   ...
   <li>  </li>  
       <div class=""index-banner"">
				   ...
				   <article style=""position: absolute; width: 100%; opacity: 0;""> 
				   	 <div class=""banner-wrap"">
						 ...
						 <div class=""slider-right"">
						    ...
						    <h2>White</h2>
						    <p>Lorem ipsum dolor sit amet</p>
						    <div class=""btn""><a href=""sh");
            WriteLiteral(@"op.html"">Shop Now</a></div>
						 </div>
						 <div class=""clear""></div>
					 </div>
				   </article>
            ...
            WriteLiteral(@" <div class=""clear""></div>
                ...
                <ul class=""wmuSliderPagination"">
                 ...
                 <a class=""wmuSlider");
            WriteLiteral(@"Prev"">Previous</a><a class=""wmuSliderNext"">Next</a><ul class=""wmuSliderPagination""><li><a href=""#"" class=""wmuActive"">0</a></li><li><a href=""#"" class="""">1</a></li><li><a href=""#"" class="""">2</a></li><li><a href=""#"" class="""">3</a></li><li><a href=""#"" class="""">4</a></li></ul></div>
                ...
                <div class=""wrap"">
             	  <div class=""content-top"">
					...
					<div class=""cont span_2_of_c1"">
					  <div class=""social"">	
					     <ul>	
						  <li class=""facebook""><a href=""#""><span> </span></a><div class=""radius""> <img src=""images/radius.png""><a href=""#""> </a></div><div class");
            WriteLiteral(@"=""border hide""><p class=""num"">1.51K</p></div></li>
						 </ul>
			   		   </div>
					   <div class=""social"">	
						   <ul>	
				  ...
				  <div class=""content-bottom"">
				   <div class=""box1"">
				    <d");
            WriteLiteral(@"iv class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				    ...
				    <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        ...
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-4"" name=""rating-input-1"">
				        <label for=""rating-input-1-4"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""r");
            WriteLiteral(@"ating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
				        <label for=""rating-input-1-2"" class=""rating-star""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-1"" name=""rating-input-1"">
            ...
            WriteLiteral(@"""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
				        <label for=""rating-input-1-2"" class=""rating-star""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-1"" name=""rating-input-1"">
				  ...
				  <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        ...
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-4"" name=""rating-input-1"">
				        <label for");
            WriteLiteral(@"=""rating-input-1-4"" class=""rating-star1""></label>
				    ...
				    <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        ...
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-4"" name=""rating-input-1"">
		");
            WriteLiteral(@"		        <label for=""rating-input-1-4"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
				        <label for=""rating-input-1-2"" class=""rating-star""></label>
						 ...
						 <ul class=""list"">
						  <li>
							  ...
							  <li><a class=""active-icon c1"" href=""#"">Add To Bag </a>
								<ul class=""sub-icon1 list"">
									<li><h3>sed diam nonummy</h3><a href=""""></a></li>
									<li><p>Lorem ipsum dolor sit amet, consectetuer  <a href="""">adipiscing elit, sed dia");
            WriteLiteral(@"m</a></p></li>
								</ul>
							  </li>
							 </ul>
						   </li>
				   ...
				   <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-5"" name=""rating-input-1"">
				        <label for=""rating-input-1-5"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-4"" name=""r");
            WriteLiteral(@"ating-input-1"">
				        <label for=""rating-input-1-4"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
						 ...
						 <ul class=""list"">
						  <li>
							  ...
							  <li><a class=""active-icon c1"" href=""#"">Add To Bag </a>
								<ul class=""sub-icon1 list"">
									<li><h3>sed diam nonummy</h3><a href=""""></a></li>
									<li><p>Lorem ipsum dolor sit amet, consectetuer  <a href="""">adipi");
            WriteLiteral(@"scing elit, sed diam</a></p></li>
								</ul>
							  </li>
							 </ul>
						   </li>
        ...
        <div class=""footer"">
       	  <div class=""footer-top"">
       		<div class=""wrap"">
				   ...
				   <div class=""col_1_of_footer-top span_1_of_footer-top"">
				  	<ul class=""f_list"">
				  	 	<li><img src=""images/f_icon2.png");
            WriteLiteral(@""" alt=""""/><span class=""delivery"">Fast delivery & free returns</span></li>
				  	 </ul>
				   </div>
				  <div class=""clear""></div>
			 </div>
				...
				<div class=""col_1_of_middle span_1_of_middle"">
			        ...
			        <dd>
			            <ul>
			                ...
			                <l");
            WriteLiteral(@"i><a href=""#"">United Kingdom<img class=""flag"" src=""images/uk.png"" alt="""" /><span class=""value"">UK</span></a></li>
            ...
            WriteLiteral(@"
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""list1"">
			            ...
			            <li><a href=""sh");
            WriteLiteral(@"op.html"">Football Boots</a></li>
            ...
            WriteLiteral(@"l"">Tennis</a></li>
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""list1"">
			            ...
			            <li><a hr");
            WriteLiteral(@"ef=""shop.html"">ZX</a></li>
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""list1"">
					    ...
					    <li><a href");
            WriteLiteral(@"=""shop.html"">Hoodies & Track Tops</a></li>
					    ...
					    <");
            WriteLiteral(@"li><a href=""shop.html"">Scarves</a></li>
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""list1"">
					   ...
					   <li><a href=""shop");
            WriteLiteral(@".html"">Gift Card</a></li>
       ...
       <script type=""text/javascript"">
        ...
        <a href=""#"" id=""toTop"" style=""display: block");
            WriteLiteral(";\"><span id=\"toTopHover\" style=\"opacity: 1;\"></span></a>\r\n\r\n</html>");
            EndContext();
        }
