#pragma checksum "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\About.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "15fa3961072a766d9d21bebc8d9862cb7251102a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"15fa3961072a766d9d21bebc8d9862cb7251102a", @"/Views/Home/About.cshtml")]
    ...
    public class Views_Home_About : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\About.cshtml"
...
#line 4 "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\About.cshtml"
...
#line 5 "c:\Users\Grek4z\Documents\GitHub\zayusu\Views\Home\About.cshtml"
Write(ViewData["Message"]);

#line default
#line hidden
            EndContext();
            BeginContext(94, 28777, true);
            WriteLiteral(@"</h3>

<p>somos una zapateria we</p>
				   ...
				   <article style=""position: absolute; width: 100%; opacity: 0;""> 
				   	 <div class=""banner-wrap"">
						 ...
						 <div class=""slider-right"">
						    ...
						    <p>Lorem ipsum dolor sit amet</p>
");
            WriteLiteral(@"						    <div class=""btn""><a href=""shop.html"">Shop Now</a></div>
						 </div>
						 <div class=""clear""></div>
					 </div>
				   </article>
				   ...
				   <article style=""position: absolute; width: 100%; opacity: 0;"">
				   	<div class=""banner-wrap"">
						 ...
						 <div class=""slider-right"">
						    ...
						    <h2>White</h2>
						    <p>Lorem ipsum dolor sit amet</p>
						    <div class=""btn""><a href=""shop.html"">Sho");
            WriteLiteral(@"p Now</a></div>
						 </div>
						 <div class=""clear""></div>
					 </div>
				   </article>
                ...
                <div class=""wrap"">
             	  <div class=""content-top"">
					...
					<div class=""cont span_2_of_c1"">
					  <div class=""social"">	
					     <ul>	
						  <li class=""facebook""><a href=""#""><span> </span></a><div class=""radius""> <img src=""images/radius.");
            WriteLiteral(@"png""><a href=""#""> </a></div><div class=""border hide""><p class=""num"">1.51K</p></div></li>
						 </ul>
			   		   </div>
					   <div class=""social"">	
						   <ul>	
            ...
            WriteLiteral(@"s=""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				    ...
				    <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        ...
				        <label for=""rating-input-1-4"" class=""rating-star1""></label>
				        <input t");
            WriteLiteral(@"ype=""radio"" class=""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
				        <label for=""rating-input-1-2"" class=""rating-star""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-1"" name=""rating-input-1"">
...
");
				  ...
				  <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-5"" name=""rating-input-1"">
				        <label for=""rating-input-1-5"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-4"" name=""ra");
            WriteLiteral(@"ting-input-1"">
				        <label for=""rating-input-1-4"" class=""rating-star1""></label>
						 ...
						 <ul class=""list"">
						  <li>
							  ...
							  <li><a class=""active-icon c1"" href=""#"">Add To Bag </a>
								<ul class=""sub-icon1 list"">
									<li><h3>sed diam nonummy</h3><a href=""""></a></li>
									<li><p>Lorem ipsum dolor sit amet, consectetuer  <a href="""">adipis");
            WriteLiteral(@"cing elit, sed diam</a></p></li>
								</ul>
							  </li>
							 </ul>
						   </li>
				    ...
				    <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-5"" name=""rating-input-1"">
				        <label for=""rating-input-1-5"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating");
            WriteLiteral(@"-input-1-4"" name=""rating-input-1"">
				        <label for=""rating-input-1-4"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
						 ...
						 <ul class=""list"">
						  <li>
							  ...
							  <li><a class=""active-icon c1"" href=""#"">Add To Bag </a>
								<ul class=""sub-icon1 list"">
									<li><h3>sed diam nonummy</h3><a href=""""></a></li>
									<li><p>Lorem ipsum dolor sit amet, consectetue");
            WriteLiteral(@"r  <a href="""">adipiscing elit, sed diam</a></p></li>
								</ul>
							  </li>
							 </ul>
						   </li>
				   ...
				   <div class=""col_1_of_3 span_1_of_3""><a href=""single.html"">
				     <div class=""view view-fifth"">
					   ...
					   <span class=""rating"">
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-5"" name=""rating-input-1"">
				        <label for=""rating-input-1-5"" class=""rating-star1""></label>
				        <input type=""radio"" class=""ratin");
            WriteLiteral(@"g-input"" id=""rating-input-1-4"" name=""rating-input-1"">
				        <label for=""rating-input-1-4"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-3"" name=""rating-input-1"">
				        <label for=""rating-input-1-3"" class=""rating-star1""></label>
				        <input type=""radio"" class=""rating-input"" id=""rating-input-1-2"" name=""rating-input-1"">
						 ...
						 <ul class=""list"">
						  <li>
							  ...
							  <li><a class=""active-icon c1"" href=""#"">Add To Bag </a>
								<ul class=""sub-icon1 list"">
									<li><h3>sed diam nonummy</h3><a href=""""></a></li>
									<li><p>Lorem ipsum dolor si");
            WriteLiteral(@"t amet, consectetuer  <a href="""">adipiscing elit, sed diam</a></p></li>
								</ul>
							  </li>
							 </ul>
						   </li>
        ...
        <div class=""footer"">
       	  <div class=""footer-top"">
       		<div class=""wrap"">
				   ...
				   <div class=""col_1_of_footer-top span_1_of_footer-top"">
				  	<ul class=""f_list"">
			");
            WriteLiteral(@"	  	 	<li><img src=""images/f_icon2.png"" alt=""""/><span class=""delivery"">Fast delivery & free returns</span></li>
				  	 </ul>
				   </div>
				  <div class=""clear""></div>
			 </div>
				...
				<div class=""col_1_of_middle span_1_of_middle"">
			        ...
			        <dd>
			            <ul>
			                ...
			                <li><a href=""#"">Pakistan<img class=""flag"" src=""images/pk.png"" alt="""" /><span class=""value"">Pk<");
            ...
            WriteLiteral(@"wrap"">
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""sub_list"">
				        ...
				        <ul class=""sub_list"">
				 ");
            WriteLiteral(@"           <h4 class=""m_10"">style</h4>
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""list1"">
			            ...
			            <li><a href=""shop.html"">Football</a");
            WriteLiteral(@"></li>
            ...
            WriteLiteral(@"Jerseys</a></li>
					    ...
					    <li><a href=""shop.");
            WriteLiteral(@"html"">Sports Bras</a></li>
				...
				<div class=""col_1_of_5 span_1_of_5"">
					...
					<ul class=""list1"">
					   ...
					   <li><a href=""shop.html"">Site M");
            WriteLiteral(@"ap</a></li>
       ...
       <script type=""text/javascript"">
        ...
        <a hre");
            WriteLiteral("f=\"#\" id=\"toTop\" style=\"display: block;\"><span id=\"toTopHover\" style=\"opacity: 1;\"></span></a>\r\n\r\n</html>");
            EndContext();
        }
